...
At the end, the program will display a prediciton about how the simulated consumer would feel about the flight with the specified inputs.

Then, you can click 'retry' to run another prediciton or 'exit' to close the program.